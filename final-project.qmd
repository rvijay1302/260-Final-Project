...
After plotting NYtimes scatter plot (see supplementary materials 5A) we can see a drop at the end, which is because it takes time to officially register deaths, it takes 45 days to register the deaths, so the last 45 days were removed. 
